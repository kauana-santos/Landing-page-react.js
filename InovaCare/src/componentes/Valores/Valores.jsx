  ...
  return (
    ...
    <section className='valores'>
        ...
        <div className='container-valor left'>
            <div ><img src="./img/inovação.jpg" alt=""className='imagem' /></div>
            <div>
                <h4>Inovação</h4>
        ...
        <div className='container-valor right'>
            <div ><img src="" alt="imagem" className='imagem' /></div>
            <div>
                <h4>Transparência</h4>
        ...
        <div className='container-valor right'>
            <div ><img src="https://img.freepik.com/fotos-gratis/vista-frontal-medicas-e-paciente_23-2149844600.jpg?semt=ais_hybrid&w=740" alt="" className='imagem' /></div>
            <div>
